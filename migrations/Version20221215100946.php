 ...
 */
final class Version20221215100946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D1C61FC64C FOREIGN KEY (transaction_invoice_id) REFERENCES document (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP FOREIGN KEY FK_723705D1F1899B00');
        $this->addSql('ALTER TABLE transaction DROP FOREIGN KEY FK_723705D1C61FC64C');
